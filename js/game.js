document.addEventListener('DOMContentLoaded', () => {
    ...
    function setRandomBackground() {
        const backgroundElement = document.getElementById('grid-background');
    ...
    function iniciarJogo() {
        ...
        // Set a new random background for each game
        setRandomBackground();
    ...
    function renderizarImagens() {
        ...
        // Adiciona imagens para cada palavra posicionada na barra lateral
        palavrasPosicionadas.forEach((palavra, index) => {
            if (!palavra.imagem) return;
            ...
            img.src = palavra.imagem;
            img.alt = `Dica ${index + 1}`;
            img.title = palavra.dica;
            
            // Adiciona evento para mostrar a dica ao passar o mouse sobre a imagem
            img.addEventListener('mouseover', () => {
                elementoMensagem.textContent = palavra.dica;
            });
            ...
            // Adiciona evento para mostrar a imagem em tamanho maior ao clicar
            img.addEventListener('click', (e) => {
                ...
                enlargedImg.src = palavra.imagem;
